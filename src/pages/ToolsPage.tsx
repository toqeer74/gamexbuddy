...
const ToolsPage = () => {
  return (
    <div className="container py-8 min-h-[calc(100vh-14rem)]">
      <h1 className="text-4xl font-bold mb-6 text-center neon-text-glow">Utility Tools</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <Card className="bg-white/10 backdrop-blur-md border border-white/20 text-white shadow-lg
          ...
          <CardHeader className="flex flex-col items-center text-center">
            ...
            <CardTitle className="text-2xl font-bold neon-text-glow">Can My PC Run GTA6?</CardTitle>
          </CardHeader>
        ...
        <Card className="bg-white/10 backdrop-blur-md border border-white/20 text-white shadow-lg
          ...
          <CardHeader className="flex flex-col items-center text-center">
            ...
            <CardTitle className="text-2xl font-bold neon-text-glow">Fun Quizzes & Polls</CardTitle>
          </CardHeader>
          <CardContent className="text-center text-gray-300">
        ...
        <Card className="bg-white/10 backdrop-blur-md border border-white/20 text-white shadow-lg
          ...
          <CardHeader className="flex flex-col items-center text-center">
            ...
            <CardTitle className="text-2xl font-bold neon-text-glow">Meme Generator</CardTitle>
          </CardHeader>
          <CardContent className="text-center text-gray-300">
